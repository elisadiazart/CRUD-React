...
const StyledUser = styled.div`
    ...
    &:hover{
        ...
        &::before{
            ...
            right: 0;
            border-radius: 13px;
            outline: 1.5px solid ${COLORS.textColor};
...
export{StyledUser, StyledUsers, StyledIcon, StyledName, StyledUserName, StyledUserText, StyledUserContainer, StyledButtons, StyledOnline, StyledTrash}